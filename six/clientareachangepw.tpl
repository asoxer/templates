<!-- $$$$修改密码 -->
<div class="container panel" style="max-width: 1000px; padding-top: 10px;">
    {if $successful}
    ...
    <form class="form-horizontal using-password-strength" method="post" action="clientarea.php?action=changepw" role="form">
        ...
        <div class="form-group">
            <label for="inputExistingPassword" class="col-sm-2 control-label">{$LANG.existingpassword}</label>
            <div class="col-sm-9">
